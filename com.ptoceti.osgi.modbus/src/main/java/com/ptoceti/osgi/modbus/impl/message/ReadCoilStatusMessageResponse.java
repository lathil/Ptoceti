 ...
 * PROJECT : Modbus
 * FILENAME : ReadCoilStatusMessageResponse.java
 * 
...
public class ReadCoilStatusMessageResponse extends ModbusMessageResponse {

	private byte[] arrayList = null;
	
	public ReadCoilStatusMessageResponse( byte unitID) {
		setFunctionID(ModbusMessage.READ_COIL_STATUS);
		setUnitID(unitID);
	}
	
	public ReadCoilStatusMessageResponse() {
		setFunctionID(ModbusMessage.READ_COIL_STATUS);
		setUnitID((byte)0);
	}
