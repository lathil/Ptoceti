...
@Singleton
public class WatchPoolRefreshServerResource extends AbstractServerResource {

    public static final String baseuri = "poolRefresh/";
    ...
    public WatchOut poolRefresh(@PathParam(WatchServerResource.WATCH_URI) String watchuri, Nil nil) throws ResourceException {
