 ...
 * PROJECT : Obix-Lib
 * FILENAME : XmlMessageBodyWriter.java
 * 
...
public class XmlMessageBodyWriter implements MessageBodyWriter<Obj> {
    ...
    public boolean isWriteable(Class<?> aClass, Type type, Annotation[] annotations, MediaType mediaType) {
        return (aClass.isAssignableFrom(Obj.class) && mediaType.isCompatible(MediaType.APPLICATION_JSON_TYPE));
    }

    @Override
    public void writeTo(Obj obj, Class<?> aClass, Type type, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, Object> multivaluedMap, OutputStream outputStream) throws IOException, WebApplicationException {
