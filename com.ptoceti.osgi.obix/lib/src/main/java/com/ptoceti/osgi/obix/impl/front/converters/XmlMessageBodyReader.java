 ...
 * PROJECT : Obix-Lib
 * FILENAME : XmlMessageBodyReader.java
 * 
...
public class XmlMessageBodyReader implements MessageBodyReader<Obj> {
    ...
    @Override
    public Obj readFrom(Class<Obj> aClass, Type type, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, String> multivaluedMap, InputStream inputStream) throws IOException, WebApplicationException {
