...
@Singleton
public class WatchRemoveServerResource extends AbstractServerResource {

    public static final String baseuri = "remove/";
    ...
    public Nil removeWatch(@PathParam(WatchServerResource.WATCH_URI) String watchuri, WatchIn in) throws ResourceException {
