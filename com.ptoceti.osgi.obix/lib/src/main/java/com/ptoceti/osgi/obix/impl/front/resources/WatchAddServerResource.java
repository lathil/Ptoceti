...
@Singleton
public class WatchAddServerResource extends AbstractServerResource {

    public static final String baseuri = "add/";
    ...
    public WatchOut addWatch(@PathParam(WatchServerResource.WATCH_URI) String watchuri, WatchIn in) throws ResourceException {
