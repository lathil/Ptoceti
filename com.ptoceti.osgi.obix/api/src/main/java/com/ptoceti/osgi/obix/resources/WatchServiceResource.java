 ...
 * PROJECT : Obix-Api
 * FILENAME : WatchServiceResource.java
 * 
...
public interface WatchServiceResource {

	public static String uri = "/watchservice/";
	
	@Get
	public WatchService retrieve() throws ResourceException;
	
	@Post
	Watch make(Nil nil) throws ResourceException;
}
