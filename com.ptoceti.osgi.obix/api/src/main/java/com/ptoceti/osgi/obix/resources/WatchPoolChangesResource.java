 ...
 * PROJECT : Obix-Api
 * FILENAME : WatchPoolChangesResource.java
 * 
...
public interface WatchPoolChangesResource {

	public static String baseuri = "poolchanges/";
	
	public static String uri = WatchResource.uri.concat(baseuri);
	
	@Post
	WatchOut poolChanges(Nil nil) throws ResourceException;
}
