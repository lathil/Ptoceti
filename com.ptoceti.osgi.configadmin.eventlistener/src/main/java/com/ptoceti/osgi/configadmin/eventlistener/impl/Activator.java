...
public class Activator implements BundleActivator {
    ...
    private EventPublisherConfigurationListener eventPublisherConfigurationListener;
    ...
    public void stop(BundleContext context) {
        ...
        if (eventPublisherConfigurationListener != null) {
            eventPublisherConfigurationListener.stop();
        }
        ...
        public void serviceChanged(ServiceEvent event) {
            ...
            switch (event.getType()) {
                case ServiceEvent.REGISTERED: {
                    ...
                    if (eventPublisherConfigurationListener == null) {
                        eventPublisherConfigurationListener = new EventPublisherConfigurationListener();
                    }
