...
public class SerialDeviceFactory implements org.osgi.service.cm.ManagedServiceFactory {
    ...
    public SerialDeviceFactory() {
        // create a new hastable that will contain references to all the TeleinfoDevice modules.
        serialDevServices = new Hashtable<String, SerialDeviceImpl>();
        // register the class as a service factory.
        Hashtable properties = new Hashtable();
        properties.put(Constants.SERVICE_PID, "com.ptoceti.osgi.serialdevice.rxtx.SerialDeviceFactory");
    ...
    public void updated(String pid, Dictionary properties) {
        ...
        SerialDeviceImpl device = new SerialDeviceImpl(pid, port);
    ...
    /**
     * Add a TeleinfoDevice object to the internal list
     *
