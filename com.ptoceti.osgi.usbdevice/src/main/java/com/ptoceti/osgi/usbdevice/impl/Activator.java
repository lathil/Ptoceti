...
public class Activator implements BundleActivator {
    ...
    static UsbDeviceFactoryImpl usbSerialDeviceListener;
    ...
    public void stop(BundleContext context) {
        ...
        if (usbSerialDeviceListener != null) {
            usbSerialDeviceListener.stop();
            usbSerialDeviceListener = null;
        }
        Activator.bc = null;
    }
        ...
        public void serviceChanged(ServiceEvent event) {
            ...
            switch (event.getType()) {
                case ServiceEvent.REGISTERED: {
                    ...
                    if (usbSerialDeviceListener == null) {
                        try {
                            usbSerialDeviceListener = new UsbDeviceFactoryImpl();
                            usbSerialDeviceListener.start();
                        } catch (Exception ex) {
                            usbSerialDeviceListener = null;
                            Activator.getLogger().error("Error starting UsbDeviceListener: " + ex.toString());
                        }
                    }
                }
                break;
