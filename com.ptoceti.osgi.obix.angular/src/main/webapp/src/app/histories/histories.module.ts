...
@NgModule({
    imports: [
        CommonModule, FormsModule, MomentModule, BsDatepickerModule.forRoot(), CollapseModule.forRoot(), HistoriesRoutingModule, SearchModule, FontAwesomeModule, D3Module
    ],
