 ...
 * #L%
 */
define([ 'backbone', 'marionette', 'underscore', 'jquery', 'moment', 'models/obix', 'modelbinder', 'courier', "i18n!nls/unittext", "i18n!nls/statustext", 'bootstrap' ], function(Backbone, Marionette, _, $, Moment, Obix, ModelBinder, Courier, unitText, statusText) {
	...
	var IntroItemView = Backbone.Marionette.ItemView.extend({
		...
		onRender : function(){
			this.modelbinder.bind(this.model, this.el, {
				...
				val: [{selector: '[name=val]'}, {selector: '[name=variance]', elAttribute:'class', converter: this.varianceConverter}, {selector: '[name=varianceText]', converter: this.varianceTextConverter}],
