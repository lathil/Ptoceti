package com.ptoceti.osgi.usb.api.impl;
...
public class Activator implements BundleActivator {
    ...
    static final String logFactoryName = LoggerFactory.class.getName();

    static UsbServices usbServices;
    private ServiceRegistration usbServiceReg;
    ...
    public void stop(BundleContext context) {
        ...
        if (usbServiceReg != null) {
            usbServiceReg.unregister();
        }
                ...
                case ServiceEvent.REGISTERED: {
                    ...
                    if (usbServiceReg == null) {
                        try {
                            ...
                            Activator.getLogger().error("Error getting UsbService implmentation: " + ex.toString());
                        }
                    }
    ...
    private void registerUsbServices() throws UsbException {

        usbServices = UsbHostManager.getUsbServices();

        String[] clazzes = new String[]{
                UsbServices.class.getName(),
        };
        Hashtable<String, Object> properties = new Hashtable<String, Object>();
        properties.put(Constants.SERVICE_PID, usbServices.getClass().getName());
        usbServiceReg = Activator.bc.registerService(clazzes, usbServices, properties);
        Activator.getLogger().info("Registered " + UsbServices.class.getName() + ", Pid = " + usbServices.getClass().getName());
    }
